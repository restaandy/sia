...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>aset/bootstrap/css/jasny-bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>aset/external/css/ionicons.min.css">
  <!-- Theme style -->
  ...
  <link href="<?php echo base_url(); ?>aset/external/css/jquery-ui.min.css" rel="stylesheet" type="text/css" />

<script src="<?php echo base_url(); ?>aset/plugins/jQuery/jQuery-2.2.0.min.js"></script>
<script src="<?php echo base_url(); ?>aset/external/js/jquery-ui.min.js"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Sistem</b>Akademik</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $this->session->userdata('nama_sekolah'); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2015 Almsaeed Studio & Recode by : <a href="http://praktisikomputer.com">Andy Resta P</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="<?php echo base_url(); ?>aset/bootstrap/js/jasny-bootstrap.min.js"></script>
